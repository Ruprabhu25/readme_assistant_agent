...
export function makeSaveReadmeTool(
  ...
  return tool({
    description:
      "Propose documentation content (README, API docs, contributor guide, quickstart, etc.) to save to the workspace. This does NOT write the file — it stages a proposal that the user must confirm before anything is written to disk.",
